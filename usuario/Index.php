...
if((!isset($_SESSION['usuario']) == true) and (!isset($_SESSION['senha']) == true))
    {
        ...
        header('Location: /farmatec/login.php');
    }
    $logado = $_SESSION['usuario'];
// if
// {
//   include_once('../databases/BdturmaConect.php');
//   $query = "SELECT * FROM tbusuarios IF logado=1"
...
<nav class="container-fluid navbar navbar-expand-sm navbar-dark sticky-top" id="nav">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- <form class="mx-auto" action="trocarsenha.php" method="POST"> 
    <input class="btn btn-danger" type="submit" name="submit" value="Trocar Senha">
    </form>       -->
    <img class="numerocar" src="../Imagens/carrinho.png">
  </nav>
        ...
        <div id="demo" class="carousel slide " data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img  src="../imagens/Banner3.png" alt="Novidades" class="d-block w-100">
              </div>
              <div class="carousel-item">
                <img  src="../imagens/Banner gillete.jpg" alt="Novidades" class="d-block w-100">
              </div>
              <div class="carousel-item">
                <img  src="../imagens/Banner rexona.jpg" alt="Novidades" class="d-block w-100">
              </div>
            </div>
          </section>
    ...
    <Section class="container-fluid">
        ...
        <!-- catalogo -->
<div id="ofertas">
  <p><strong>ㅤOfertas da semana</strong> </p>
  </div>
  <br><br>
  ...
  <div class="card-deck">
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/remedio.png" alt="Card image cap"></a>
      <div class="card-body">
      <p id="nomeprod"><strong>Dipirona 500mg/mL</strong></p>
      <p><strong>FarmaTec</strong></p>
      <h6 class="card-subtitle">De  R$ <s>15,99</s></h6>
        <p class="card-text">Por R$ 11,99</p>
...
<div id="ofertas">
  ...
  <div class="card-deck">
    ...
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/tarjapreta.png" alt="Card image cap"></a>
      <div class="card-body">
        <p id="nomeprod"><strong>Rivotril 0,5mg</strong></p>
        <p><strong>FarmaTec</strong></p>
        <p class="card-text">Por R$  24,49</p>
    ...
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/remedio.png" alt="Card image cap"></a>
      <div class="card-body">
        <p id="nomeprod"><strong>Pilula do Dia Seguinte</strong></p>
        <p><strong>FarmaTec</strong></p>
        <p class="card-text">Por R$  9,99</p>
        <h6 class="card-subtitle">ㅤㅤㅤㅤ</h6>
        <button type="button" class="btn btn-danger col-md-12"><a id="botao" href="index.php">Comprar</a></button>
    ...
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/tarjapreta.png" alt="Card image cap"></a>
      <div class="card-body">
        <p id="nomeprod"><strong>Venvanse 70mg</strong></p>
        <p><strong>FarmaTec</strong></p>
        <p class="card-text">Por R$ 462,42</p>
        <h6 class="card-subtitle">ㅤㅤㅤㅤ</h6>
        <button type="button" class="btn btn-danger col-md-12"><a id="botao" href="index.php">Comprar</a></button>
    ...
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/remedio.png" alt="Card image cap"></a>
      <div class="card-body">
        <p id="nomeprod"><strong>Cetozonazol 200mg</strong></p>
        <p><strong>FarmaTec</strong></p>
        <p class="card-text">Por R$  20,79</p>
        <h6 class="card-subtitle">ㅤㅤㅤㅤ</h6>
        <button type="button" class="btn btn-danger col-md-12"><a id="botao" href="index.php">Comprar</a></button>
    ...
    <div class="col-md-2">
      ...
      <a href="#" rel="noopener noreferrer"><img class="card-img-top" src="../Produtos/remedio.png" alt="Card image cap"></a>
      <div class="card-body">
        <p id="nomeprod"><strong>Atenol 25mg</strong></p>
        <p><strong>FarmaTec</strong></p>
        <p class="card-text">Por R$  5,80</p>
        <h6 class="card-subtitle">ㅤㅤㅤㅤ</h6>
        <button type="button" class="btn btn-danger col-md-12"><a id="botao" href="index.php">Comprar</a></button>
...
<section>
  ...
  <div class="col-lg-6">
    ...
    <figure>
      ...
      <a href="promocoes.php" rel="noopener noreferrer" ><img class="w-100" src="../imagens/Promoções imperdiveis BANNER.jpg" alt=""></a>
  ...
  <div class="col-lg-6">
    ...
    <figure>
      ...
      <a href="#" rel="noopener noreferrer" ><img class="w-100" src="../imagens/OMEGA3  BANNER.jpg" alt=""></a>
