      ...
      <br><br>
        ...
        <div class="card-deck">
          <div class="col-md-2">
            ...
            <div class="card-body">
            <p id="nomeprod"><strong>Dipirona Genérico 500mg/mL</strong></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <a href="index.php"><img src="../Imagens/logo branca.png" alt="" width="32px">FarmaTec Loja Online</a>
                        <p>
                            FarmaTec <br>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <div class="socail-links mt-3">
                          <a href="index.php"><img src="../Imagens/whatsapp.png" alt="" width="32px"></a>
                          <a href="index.php"><img src="../Imagens/facebook.png" alt="" width="32px"></a>
                          <a href="index.php"><img src="../Imagens/instagram.png" alt="" width="32px"></a>
                        </div>
                    </div>
